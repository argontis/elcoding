...
<div data-elementor-type="wp-page" data-elementor-id="6296" class="elementor elementor-6296" data-elementor-post-type="page">
    ...
    <style>
        ...
        .client-logo img { width: 100%; height: 80px; object-fit: contain; filter: grayscale(100%); opacity: 0.6; transition: all 0.3s ease; }
        ...
        @media (max-width: 768px) { .client-logo { flex: 0 0 50%; height: 100px; } .client-logo img { height: 60px; } }
    </style>
