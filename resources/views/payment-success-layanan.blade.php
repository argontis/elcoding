<x-layout title="Status Pembayaran">
    ...
    <div class="payment-status-container">
        @if($order && in_array($order->status, ['paid', 'PAID', 'SETTLED']))
            ...
            <p class="status-desc">
                Terima kasih, <strong>{{ $order->user_name }}</strong>! Pembayaran untuk program <strong>{{ $order->layanan->title ?? 'Kursus' }}</strong> telah kami terima.
            </p>
        @else
        ...
        <div class="order-info-box">
            ...
            <div class="order-info-item">
                ...
                <span class="font-semibold">{{ $order->layanan->title ?? '-' }}</span>
            </div>
            <div class="order-info-item">
