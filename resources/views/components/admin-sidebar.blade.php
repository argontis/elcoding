<aside class="sidebar w-72 flex flex-col h-full shrink-0 z-20 shadow-xl shadow-slate-900/10 border-r border-slate-800">
    ...
    <nav class="flex-1 overflow-y-auto py-6 space-y-1">
        ...
        <a href="/dashboard" class="sidebar-item flex items-center gap-4 font-medium {{ request()->is('dashboard') ? 'active' : '' }}">
            <i class="fas fa-chart-pie w-6 text-center text-lg"></i> <span>Dashboard (RFM)</span>
        </a>
        ...
        <a href="/admin/event" class="sidebar-item flex items-center gap-4 font-medium {{ request()->is('admin/event*') ? 'active' : '' }}">
            <i class="fas fa-calendar-alt w-6 text-center text-lg"></i> <span>Event & Webinar</span>
        </a>
