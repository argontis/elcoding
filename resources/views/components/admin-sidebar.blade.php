<aside id="app-sidebar" class="sidebar fixed inset-y-0 left-0 w-[260px] flex flex-col h-screen shrink-0 z-[100] shadow-xl shadow-slate-900/10 border-r border-slate-800 transition-all duration-300">
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden sidebar-scroll">
        <nav class="py-4 space-y-1">
            ...
            <a href="{{ url('/dashboard') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/layanan') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/layanan*') ? 'active' : '' }}">
                <i class="fas fa-server w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Layanan Utama</span>
            </a>

            <a href="{{ url('/admin/mitra') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/mitra*') ? 'active' : '' }}">
                <i class="fas fa-handshake w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Klien & Mitra</span>
            </a>
            
            <a href="{{ url('/admin/program-kursus') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/program-kursus*') ? 'active' : '' }}">
                <i class="fas fa-graduation-cap w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Program Kursus</span>
            </a>

            <a href="{{ url('/admin/event') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/event*') ? 'active' : '' }}">
                <i class="fas fa-calendar-alt w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Event & Webinar</span>
            </a>

            <a href="{{ url('/admin/kategori-portofolio') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/kategori-portofolio*') ? 'active' : '' }}">
                <i class="fas fa-tags w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Kategori Portofolio</span>
            </a>
            
            <a href="{{ url('/admin/portofolio') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/portofolio*') ? 'active' : '' }}">
                <i class="fas fa-briefcase w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">Portofolio</span>
            </a>
            
            <a href="{{ url('/admin/artikel') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/artikel*') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/settings') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/settings*') ? 'active' : '' }}">
            ...
            @endphp
            <a href="{{ url('/admin/orders') }}" class="sidebar-item flex items-center justify-between font-medium {{ request()->is('admin/orders*') ? 'active' : '' }}">
            ...
            <a href="{{ url('/admin/mou') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/mou*') ? 'active' : '' }}">
                <i class="fas fa-file-signature w-6 text-center text-[15px]"></i> <span class="text-[14px] sidebar-text">MoU & Penawaran</span>
            </a>

            <a href="{{ url('/admin/pkl') }}" class="sidebar-item flex items-center gap-3 font-medium {{ request()->is('admin/pkl*') ? 'active' : '' }}">
