<x-layout title="Status Pembayaran Event">
    <style>
        ...
        .btn-home:hover, .btn-home:focus, .btn-home:active, .btn-home:visited {
            ...
            text-decoration: none !important;
            box-shadow: 0 6px 20px rgba(26, 86, 130, 0.5);
        }
    </style>
    ...
    <div class="payment-status-container">
        @if($order && in_array($order->status, ['paid', 'PAID', 'SETTLED']))
            ...
            <p class="status-desc">
                Terima kasih, <strong>{{ $order->user_name }}</strong>! Pembayaran untuk <strong>Event & Webinar</strong> telah kami terima. Link akses dan informasi lebih lanjut akan dikirim ke email dan WhatsApp Anda.
            </p>
        @else
        ...
        <div class="order-info-box">
            ...
            <div class="order-info-item">
                ...
                <span class="font-semibold">Pendaftaran Event & Webinar</span>
            </div>
            <div class="order-info-item">
                <span class="text-gray-500">Total Pembayaran:</span>
                <span class="font-bold text-blue-600">Rp{{ number_format($order->amount, 0, ',', '.') }}</span>
            </div>
            <div class="order-info-item">
        ...
        <a href="{{ url('/event-webinar') }}" class="btn-home">
