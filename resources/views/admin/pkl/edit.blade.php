        ...
        <form action="{{ route('admin.pkl.update', $profile->id) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4 pt-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-slate-700 mb-1">Divisi / Posisi Magang</label>
                        <input type="text" name="division" value="{{ old('division', $profile->division) }}" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-blue-500" placeholder="Misal: Web Developer">
                    </div>
                </div>
