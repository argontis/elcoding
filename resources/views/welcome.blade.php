...
<div data-elementor-type="wp-page" data-elementor-id="6296" class="elementor elementor-6296" data-elementor-post-type="page">
    ...
    <style>
        ...
        .client-logo img { width: 100%; height: 90px; object-fit: contain; filter: grayscale(100%); opacity: 0.6; transform: scale(1.3); transition: all 0.3s ease; }
        .client-logo img:hover { filter: grayscale(0); opacity: 1; transform: scale(1.4); }
        ...
        @media (max-width: 768px) { .client-logo { flex: 0 0 50%; height: 100px; } .client-logo img { height: 75px; transform: scale(1.2); } .client-logo img:hover { transform: scale(1.3); } }
    </style>
