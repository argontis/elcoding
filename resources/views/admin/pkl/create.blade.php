            ...
            <div class="space-y-4 pt-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="division" value="{{ old('division') }}" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-800 focus:outline-none focus:border-blue-500" placeholder="Misal: Web Developer">
                    </div>
                </div>
